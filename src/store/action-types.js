...
// excel
export const EXCEL_SET_DATA = "EXCEL_SET_DATA";
export const EXCEL_CLEAR_DATA = "EXCEL_CLEAR_DATA";
export const EXCEL_SET_QUERY_FILTERS = "EXCEL_SET_QUERY_FILTERS";
export const EXCEL_CLEAR_QUERY_FILTERS = "EXCEL_CLEAR_QUERY_FILTERS";
